...
class DW_arm946_example// Arm946 Basic Test Design
: public sc_module
{
...
public:
    ...
    CCSS_PARAMETER(unsigned int, dbus_ratio);

    // ibus clock enable ratio
    CCSS_PARAMETER(unsigned int, ibus_ratio);
    ...
    sc_signal<bool> C205;
    sc_signal<bool> C206;
    sc_signal<sc_bv<NUM_MASTERS> > C207;
    sc_signal<bool> HCLK;
    sc_signal<bool> High;
    ...
    DW_IntrGen<ahb_slave_if > *IntrGen;
    ...
    virtual void InitParameters() {
        ...
        unsigned int _tmp_dbus_ratio = 1;
        dbus_ratio.conditional_init(_tmp_dbus_ratio);
        unsigned int _tmp_ibus_ratio = 1;
