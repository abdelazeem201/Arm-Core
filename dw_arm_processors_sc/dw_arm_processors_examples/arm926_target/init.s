...
IRQ_Addr        DCD     irq_hndlr
FIQ_Addr        DCD     fiq_hndlr
    ENDIF
...
;; Turn on DTCM
         MOV     r3, #0x00020000          ; Base=0x20000
         ORR     r3, r3, #0x1             ; Enabled
         MCR     p15, 0, r3, c9, c1, 0    ; Set DTCM Base/enable
                                          ; NOTE: To modify DTCM size, you
                                          ; have to modify the DRamSize
                                          ; in coveracs.ami in the $ARMCONF
                                          ; directory. Default is 64KB
             

;; Turn on ITCM
         MOV     r3, #0x000ff000          ; Base=0xff000
         ORR     r3, r3, #0x1             ; Enabled
         MCR     p15, 0, r3, c9, c1, 1    ; Set ITCM Base/enable
                                          ; NOTE: To modify ITCM size, you
                                          ; have to modify the IRamSize
                                          ; in coveracs.ami in the $ARMCONF
                                          ; directory. Default is 64KB
